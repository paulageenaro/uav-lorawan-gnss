...
- **Importante:** Al usar el modo sleep, el puerto USB de la placa se apagará temporalmente entre ciclos. Es un comportamiento esperado, no un fallo. Tu ordenador hará el sonido de desconectar/conectar USB.
...
- **Importante:** Utiliza este código si estás programando o monitorizando el puerto serie (Serial Monitor) y necesitas ver las trazas continuas (como el `JoinAccept`) sin que se corte la conexión USB.
